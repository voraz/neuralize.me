...
package org.puremvc.as3.patterns.mediator
{
	...
	public class Mediator extends Notifier implements IMediator, INotifier
	{
		 ...
		 * 
		 */		
		protected function sendEventNotification(event:Event):void
		{		    
		    sendNotification(event.type);
		}
		/**
		 * Transforma os eventos em notificações
		 * */
		protected function eventsToNotification ():void
		{
		    ...
		    {
		        if(viewComponent as EventDispatcher)
		        {		       
		            viewComponent.addEventListener(notifications[i],sendEventNotification);    
		        }
